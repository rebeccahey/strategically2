...
import OverviewSection from "./Sectionsreact/OverviewSection.jsx";
import SectionExamples from "./Sectionsreact/SectionExamples.jsx";
  ...
  render() {
    ...
    return (
      ...
      />
        ...
        <Parallax image={require("assets/img/react_development.webp")}>
          <div className={classes.container}>
            <GridContainer>
              ...
              fontSize: "60px"},
              '@media (min-width: 800px)': {textAlign: "left", paddingLeft: "200px", paddingRight: "360px", fontSize: "70px"}}}>React JS Development Company</h1>
