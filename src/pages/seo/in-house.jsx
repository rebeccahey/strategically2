...
import OverviewSection from "./Sectionsinhouse/OverviewSection.jsx";
import SectionExamples from "./Sectionsinhouse/SectionExamples.jsx";
        ...
        <Parallax image={require("assets/img/ServiceImage.jpg")}>
          <div className={classes.container}>
            <GridContainer>
              ...
              fontSize: "60px"},
              '@media (min-width: 800px)': {textAlign: "left", paddingLeft: "200px", paddingRight: "360px", fontSize: "70px"}}}>In-House SEO, Team Training and Hiring</h1>
              </GridItem>
            </GridContainer>
          </div>
        </Parallax>
