        ...
        <div css={{'@media (min-width: 300px) and (max-width: 800px)': {paddingLeft: '30px', paddingRight: '30px'}}}>
          <GridContainer justify="center">
            <GridItem xs={12} sm={12} md={6}>
             ...
             <p><strong>Is your site prepared for the levels of optimisation and engagement that search engines (and ever-growing competition) demand today?</strong></p>
             <p>SEO content strategy starts with a comprehensive look at the entire industry you are trying to reach. It goes <strong>beyond auditing</strong> the search performance of the current site and includes strategy for how to <strong>attract, engage</strong> and <strong>convert qualified leads</strong> through organic search and other inbound marketing channels.</p>
             <p>Content strategy is the first step in search optimisation, where <strong>audience needs</strong> and <strong>competitive landscape</strong> determine the approach for content to build, how to build it and how to market, measure and maintain it over time. This is especially important in competitive verticals online.</p>
