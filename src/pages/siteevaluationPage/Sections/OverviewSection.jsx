        ...
        <div css={{'@media (min-width: 300px) and (max-width: 800px)': {paddingLeft: '30px', paddingRight: '30px'}}}>
          <GridContainer justify="center">
            <GridItem xs={12} sm={12} md={6}>
             ...
             <p>An SEO site evaluation is an assessment of your current site's search engine optimisation and it's ability to attract target audiences and convert them through search.</p>
             ...
             <ul>
              ...
              <li>Prioritised recommendations for optimising on-site and off-site to better attract and convert qualified leads through search.</li>
              </ul>
              </p>
              </div>
             <p>
             <Link>Get started today.</Link></p>
             <div>
             </div>
          </GridItem>
          </GridContainer>
