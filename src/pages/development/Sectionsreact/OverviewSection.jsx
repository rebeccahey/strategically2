        ...
        <div css={{'@media (min-width: 300px) and (max-width: 800px)': {paddingLeft: '30px', paddingRight: '30px'}, position: 'relative', backgroundColor: '#fff', paddingTop: '30px'}}>
          <GridContainer justify="center">
            <GridItem xs={12} sm={12} md={6}>
             ...
             <p>Valuable time is saved, allowing developers to focus on application architecture and business logic. In addtion, one-way bindings make data flows easier to understand, spot issues and debug.</p>
             <p>Web pages can render faster as the use of a Virutal dom means other JavaScript frameworks, like JQuery, are not required. As faster website load speeds are important SEO signals, this benefits the SEO of your website.</p>
             <h4>React Native</h4>
             ...
             <p>The time is takes to build mobile apps is significantly reduced by the ability to reuse elements of the same codebase for mobile and web applications.</p>
             </p>
             </div>
          </GridItem>
          </GridContainer>
