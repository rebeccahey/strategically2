        ...
        <div css={{'@media (min-width: 300px) and (max-width: 800px)': {paddingLeft: '30px', paddingRight: '30px'}}}>
          <GridContainer justify="center">
            <GridItem xs={12} sm={12} md={6}>
             ...
             <p>Content strategy determines exactly what to produce (editorial content, videos, tools, etc.) to attract new visitors, retain and engage existing audiences, and promote natural sharing and links to your website.</p>
             <p>Research that goes into content strategy typically also provides insights and feedback that can go into making a better product.</p>
             ...
             <p>
              <Link to="./strategy/content-marketing">See the Strategically process for developing content strategy & marketing it.</Link></p>
             <div>
             </div>
          </GridItem>
          </GridContainer>
